import { Video, Mic, MicOff, VideoOff, MessageSquare, PhoneMissed } from 'lucide-react';
  ...
  return (
    <div className="fade-in" style={{ height: 'calc(100vh - 120px)', display: 'flex', flexDirection: 'column' }}>
      <div className="page-header" style={{ marginBottom: '16px' }}>
        ...
        <p>Sesi aktif dengan Dra. Siti Aminah, M.Psi</p>
      </div>
      ...
      <div className="card" style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '0', overflow: 'hidden', background: '#1a1a2e' }}>
        <div style={{ flex: 1, position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          {/* Main Video Area (Konselor) */}
          <div style={{ color: 'white', textAlign: 'center' }}>
            <UserIconPlaceholder />
            <p style={{ marginTop: '16px', fontSize: '1.2rem' }}>Menunggu Konselor Bergabung...</p>
          </div>

          {/* Picture in Picture (Konseli) */}
